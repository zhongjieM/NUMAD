...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
	...
	private static final String MYNS = "http://exerpacman.yingquanyuan.madcourse.neu.edu";
	...
	private void setValuesFromXml(AttributeSet attrs) {
		...
		mUnitsLeft = getAttributeStringValue(attrs, MYNS, "unitsLeft", "");
		String units = getAttributeStringValue(attrs, MYNS, "units", "");
	...
	protected View onCreateView(ViewGroup parent) {
		...
		try {
			...
			layout = (RelativeLayout) mInflater.inflate(R.layout.exer_pacman_seekbar_preference, parent, false);
		} catch (Exception e) {
