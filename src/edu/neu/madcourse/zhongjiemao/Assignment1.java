...
public class Assignment1 extends Activity implements OnClickListener {
	 ...
	 * 
	 * @return -- true : authorized to run the program; -- false: forbidden to
	 *         run the program. the method will setup an AlertDialog to show the
	 *         warning.
	 */
	private boolean checkAuthorized() {
		...
		if (authorizedToRun)
			...
			/**
			 * This phone is not allowed to run the program! Show the warning
			 * message.
			 */
			new AlertDialog.Builder(this)
					.setTitle("Oops! Not Public!")
					.setMessage(
							"Sorry! This is a test application not intended for public use. \n"
	 ...
	 * 
	 * @param authorized
	 *            If the current phone is unauthorized to run the program: all
	 *            the button will be set to be invisible. otherwise, nothing
	...
	public void onClick(View v) {
		...
		case R.id.btn_exit:
			System.exit(0);
			break;
		case R.id.btn_persistent_boggle:
			i = new Intent(this, PersistentBoggleLogin.class);
			startActivity(i);
			break;
		default:
			return;
